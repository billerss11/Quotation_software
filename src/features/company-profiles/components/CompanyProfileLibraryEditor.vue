  ...
  <section class="editor-card" :aria-label="t('companyProfiles.editor.aria')">
    <header class="editor-heading">
      <div class="editor-heading-copy">
        <h2 class="editor-title">{{ t('companyProfiles.editor.title') }}</h2>
        <p class="editor-description">{{ t('companyProfiles.editor.description') }}</p>
      </div>
    ...
    <div class="editor-grid">
      <label class="field field-wide">
        ...
        <InputText v-model="model.companyName" autocomplete="organization" />
      </label>
      <label class="field">
    ...
    <div class="editor-actions">
      <Button icon="pi pi-save" :label="t('companyProfiles.editor.save')" @click="emit('save')" />
      <Button
        icon="pi pi-trash"
        :label="t('companyProfiles.editor.delete')"
        severity="danger"
        outlined
        :disabled="!canDelete"
        @click="emit('delete')"
